package com.mrfuzzihead.weather.client.entity.particle;
...
public class EntityFallingSnowFX extends EntityRotFX implements WindHandler {
    ...
    public EntityFallingSnowFX(World var1, double var2, double var4, double var6, double var8, double var10,
    ...
    public void renderParticle(Tessellator var1, float var2, float var3, float var4, float var5, float var6,
        ...
        // var16 = (1.3F + ModLoader.getMinecraftInstance().gameSettings.gammaSetting) -
        // (this.worldObj.calculateSkylightSubtracted(var2) * 0.13F);

        Minecraft mc = Minecraft.getMinecraft();
        float br = ((0.9F + (mc.gameSettings.gammaSetting * 0.1F))
            - (mc.theWorld.calculateSkylightSubtracted(var2) * 0.03F)) * mc.theWorld.getSunBrightness(1F);
         ...
         * WeatherUtilParticle.rainPositions[i] = Vec3.createVectorHelper((rand.nextFloat() * range) - (range/2),
         * (rand.nextFloat() * range/16) - (range/32), (rand.nextFloat() * range) - (range/2));
         * }
         */
        ...
        for (int i = 0; i < Math.min(rainDrops, WeatherUtilParticle.maxRainDrops); i++) {
             ...
             * (double)(var15 - var5 * var12 - var7 * var12), (double)0, (double)0);
             * var1.addVertexWithUV((double)(var13 - var3 * var12 + var6 * var12), (double)(var14 + var4 * var12),
             * (double)(var15 - var5 * var12 + var7 * var12), (double)0, (double)0.2);
             * var1.addVertexWithUV((double)(var13 + var3 * var12 + var6 * var12), (double)(var14 + var4 * var12),
             * (double)(var15 + var5 * var12 + var7 * var12), (double)0.2, (double)0.2);
             * var1.addVertexWithUV((double)(var13 + var3 * var12 - var6 * var12), (double)(var14 - var4 * var12),
             * (double)(var15 + var5 * var12 - var7 * var12), (double)0.2, (double)0);
             */
        }
    ...
    public void onUpdate() {
        ...
        // System.out.println("this.worldObj.getHeightValue((int)Math.floor(posX), (int)Math.floor(posZ)): " +
        // this.worldObj.getHeightValue((int)Math.floor(posX), (int)Math.floor(posZ)));

        if (this.particleAge++ >= this.particleMaxAge || this.onGround
            || this.isInWater()
            || posY + this.motionY < this.worldObj.getHeightValue((int) Math.floor(posX), (int) Math.floor(posZ))) {
            this.setDead();
        }
