package com.mrfuzzihead.weather.client.entity;
...
public class RenderCubeCloud extends Render {
    ...
    public void doRenderClouds(StormObject parStorm, double var2, double var4, double var6, float var8, float var9) {
         ...
         * GL11.glPushMatrix();
         * GL11.glTranslatef((float)WeatherUtilParticle.rainPositions[i].xCoord * 3F,
         * (float)WeatherUtilParticle.rainPositions[i].yCoord * 3F, (float)WeatherUtilParticle.rainPositions[i].zCoord *
         * 3F);
         ...
         * rb.setRenderBoundsFromBlock(renderBlock);
         * rb.renderBlockAsItem(renderBlock, 0, 0.8F);
         * //GL11.glTranslatef((float)-WeatherUtilParticle.rainPositions[i].xCoord,
         * (float)-WeatherUtilParticle.rainPositions[i].yCoord, (float)-WeatherUtilParticle.rainPositions[i].zCoord);
         * GL11.glPopMatrix();
         * }
         */
