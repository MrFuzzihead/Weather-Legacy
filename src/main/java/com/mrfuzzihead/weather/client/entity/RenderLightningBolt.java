...
public class RenderLightningBolt extends Render {
     ...
     */
    public void doRenderLightningBolt(EntityLightningBolt par1EntityLightningBolt, double par2, double par4,
        ...
        try {
            ...
            // Weather.dbg(par1EntityLightningBolt.posX + " - " + par1EntityLightningBolt.posY + " - " +
            // par1EntityLightningBolt.posZ);
