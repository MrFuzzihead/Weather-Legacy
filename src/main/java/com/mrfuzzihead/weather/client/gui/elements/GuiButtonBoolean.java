package com.mrfuzzihead.weather.client.gui.elements;
...
public class GuiButtonBoolean extends GuiButton {
    ...
    /*
     * public int texID = 0;
     * public static final ResourceLocation resGUI = new ResourceLocation(ZombieCraftMod.modID +
     * ":textures/gui/zceditgui.png");
     */
    ...
    public GuiButtonBoolean(int par1, int par2, int par3, int par4, int par5, String str,
        String parDisabled/* , int texID */) {
    ...
    public boolean mousePressed(Minecraft par1Minecraft, int par2, int par3) {
        return /* this.enabled && */this.visible && par2 >= this.xPosition
            && par3 >= this.yPosition
            && par2 < this.xPosition + this.width
            && par3 < this.yPosition + this.height;
    }
