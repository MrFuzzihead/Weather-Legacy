...
public class TileEntityAnemometerRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
        ...
        // val i: Int = 15728880
        // OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, (i % 65536).asInstanceOf[Float] / 1F, (i
        // / 65536).asInstanceOf[Float] / 1F)
        ...
        // Weather.dbg("a: " + (((TileEntityAnemometer)var1).smoothAngle + "b: " +
        // ((TileEntityAnemometer)var1).smoothAnglePrev));
        ...
        // tessellator.setBrightness(var1.getBlockType().getMixedBrightnessForBlock(var1.worldObj,
        // MathHelper.floor_double(var2), MathHelper.floor_double(var4), MathHelper.floor_double(var6)));
