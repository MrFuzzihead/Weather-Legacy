            ...
            if (var1 instanceof EntityPlayerMP) {
                ...
                if (var2[0].equals("volcano")) {
                    ...
                    if (var2[1].equalsIgnoreCase("killAll")) {
                        WeatherManagerServer wm = ServerTickHandler.lookupDimToWeatherMan
                        ...
                        if (var2.length > 2) {
                            ...
                            so.pos = Vec3
                                .createVectorHelper(player.posX, StormObject.layers.get(so.layer), player.posZ);
                            ...
                            CoroUtil.sendPlayerMsg(
                                ...
                                "storm " + var2[2]
                                    + " created"
                                    + (so.alwaysProgresses ? ", flags: alwaysProgresses" : ""));
                        } else {
