...
public class WindReader {
     ...
     * WindType.EVENT is client side only, due to wind technically being a global thing on server side, it was required
     * to make events easily location based for player
     */
