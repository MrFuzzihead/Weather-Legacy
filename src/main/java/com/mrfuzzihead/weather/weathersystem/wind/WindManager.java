package com.mrfuzzihead.weather.weathersystem.wind;
...
public class WindManager {
    ...
    public int windTimeEvent = 0; // its assumed this will get set by whatever initializes an event, and this class
                                  // counts it down from a couple seconds, helps wind system know what takes priority
    ...
    public void tickClient() {
        ...
        if (entP != null) {
            if (manager.getWorld()
                .getTotalWorldTime() % 10 == 0) {
                StormObject so = manager.getClosestStorm(
                    Vec3.createVectorHelper(entP.posX, StormObject.layers.get(0), entP.posZ),
                    256,
