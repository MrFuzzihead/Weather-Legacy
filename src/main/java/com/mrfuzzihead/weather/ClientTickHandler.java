...
import com.mrfuzzihead.weather.client.gui.GuiEZConfig;
import com.mrfuzzihead.weather.config.ConfigMisc;
import com.mrfuzzihead.weather.util.WeatherUtilConfig;
import com.mrfuzzihead.weather.weathersystem.EntityRendererProxyWeather2Mini;
...
public class ClientTickHandler {
    ...
    public void onRenderScreenTick() {
        ...
        if (mc.currentScreen instanceof GuiIngameMenu) {
            ...
            if (k >= configButton.xPosition && l >= configButton.yPosition
                && k < configButton.xPosition + 200
                && l < configButton.yPosition + 20) {
    ...
    public void onTickInGame() {
        ...
        if (world != null) {
            if (mc.ingameGUI.getChatGUI()
                .getSentMessages()
                .size() > 0) {
                String msg = (String) mc.ingameGUI.getChatGUI()
                    .getSentMessages()
                    .get(
    ...
    public static void checkClientWeather() {
        try {
            ...
            ex.printStackTrace();
            // Weather.dbg("Warning, Weather2 client received packet before it was ready to use, and failed to init
            // client weather due to null world");
        }
    }
