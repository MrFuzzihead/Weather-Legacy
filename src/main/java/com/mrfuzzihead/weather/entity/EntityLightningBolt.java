...
public class EntityLightningBolt extends EntityWeatherEffect {
    ...
    public EntityLightningBolt(World par1World, double par2, double par4, double par6) {
        ...
        if (!par1World.isRemote && (fireChance == 0 || rand.nextInt(fireChance) == 0)
    ...
    public void onUpdate() {
        ...
        if (this.lightningState < 0) {
            if (this.boltLivingTime == 0) {
                ...
                if (!this.worldObj.isRemote && rand.nextInt(fireChance) == 0
                    ...
                    if (CoroUtilBlock.isAir(worldObj.getBlock(i, j, k))
